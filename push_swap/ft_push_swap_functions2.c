...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/21 21:01:00 by mwikiera          #+#    #+#             */
/*   Updated: 2024/05/21 21:42:25 by mwikiera         ###   ########.ch       */
/*                                                                            */
/* ************************************************************************** */
...
//	ft_printf("%d\n", ft_atoi(argv[3]));
	...
	if (ft_atoi(argv[3]) > ft_atoi(argv[2]) && ft_atoi(argv[2]) > ft_atoi(argv[1]) && ft_atoi(argv[3]) > ft_atoi(argv[1]))
	{
		//swap_a(&argv, stack_a);
		reverse_rotate_a(&argv, stack_a);
